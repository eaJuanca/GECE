    ...
    <div class="row" >
        ...
        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
            ...
            <div class="well">
                ...
                <p class="text-center text_hidden">Módulo para la gestión de nichos</p>
                <p class="text-center btn_hidden"><button class="btn btn-md btn-material-amber">Entrar</button></p>
                <p class="text-center btn_show">
        ...
        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
            ...
            <div class="well">
                ...
                <p class="text-center btn_hidden"><button class="btn btn-md btn_hidden" style="background-color:#FFECB3">Entrar</button></p>
                <p class="text-center btn_show">
