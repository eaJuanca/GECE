                            ...
                            <table class="table table-bordered table-hover table-condensed">
                                ...
                                @foreach($factura as $f)
                                    ...
                                    @elseif($f->serie=='E')
                                            ...
                                            <td>{{$f->inicio}}</td>
                                            <td>-</td>
                                            <td> <a href="{{ route('pdfacturaenterramiento',[$f->id])}}"> <button class="btn btn-danger btn-xs">Descargar</button> </a><a href="{{ route('modificar-factura',[$f->id])}}"> <button class="btn btn-success btn-xs">Modificar</button> </a> <br></td>
